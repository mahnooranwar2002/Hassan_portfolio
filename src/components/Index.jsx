...
<Navbar/>
 ...
 <div className='flex gap-10 p-8  flex-col lg:flex-row '>
    <div className='w-full lg:w-5/12   lg:px-10 lg:py-30  '>
   

  <span className='text-[#FFFFFF59] text-sm font-semibold uppercase  mb-2'>
    Hello, i’m
  </span>

  <h1 className='text-[#C9F31D] font-bold tracking-tight text-6xl leading-none mb-2'>
    Md Hassan
  </h1>
  ...
  <p className='text-[#8B8B8B] text-lg leading-relaxed max-w-md'>
...
<button className="group relative ml-2 inline-block px-10 py-4 overflow-hidden rounded-md border hover:border-[#C9F31D] font-bold text-black bg-white transition-all duration-300 ease-in-out hover:text-white mt-5 hover:shadow-lg  shadow-[#070707]">
  ...
  <div className='flex justify-evenly flex-col lg:flex-row gap-15 mt-5 py-10 lg:w-6/12 '>
    <div className=''>
        <img src="https://wp.webtend.net/noxfolio/wp-content/uploads/2023/11/me.png"  className='border-5 border-[#C9F31D] rounded-full w-full' alt="" />
    </div>
